...
export default {
  ...
  created() {
    if (this.user.role === "admin") {
      ...
      let array = [];
      SidebarAdmin.default.map(i =>
        i.child ? array.push(i.child) : array.push(i)
      );
