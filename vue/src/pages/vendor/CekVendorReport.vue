<template>
  <vs-col vs-type="flex" vs-w="13" class="content">
    ...
    <vs-col class="content-body" vs-w="12">
      ...
      <!-- end button-->
      <!-- start popup -->
      <vs-popup button-close-hidden title="Daily Stock Report" :active.sync="uploadPopup">
        ...
        <vs-row vs-justify="center" vs-align="center" vs-w="10" style="padding: 5px;">
          ...
          <vs-col vs-offset="1" vs-w="6">
            <date-picker v-model="stockDate" type="date" format="DD-MM-YYYY" lang="en" />
          </vs-col>
        </vs-row>
        ...
        <vs-row vs-w="10" vs-type="flex" vs-justify="center">
